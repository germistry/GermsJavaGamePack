...
public class PipesMenuPanel extends GuiPanel {
	...
	private String gameTitle = "Pipes";
	...
	public PipesMenuPanel() {
		...
		playButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GuiScreen.getInstance().setCurrentPanel(PanelName.PIPES_PLAY);
			}
		});
		scoresButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				GuiScreen.getInstance().setCurrentPanel(PanelName.PIPES_LEADERBOARD);
			}
		});
